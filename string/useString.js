...
var Module = typeof useString !== 'undefined' ? useString : {};
...
var wasmBinaryFile = 'useString.wasm';
...
var _myCharAt = Module["_myCharAt"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["myCharAt"].apply(null, arguments)
};

var _stringLen = Module["_stringLen"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["stringLen"].apply(null, arguments)
};

var _readutf8 = Module["_readutf8"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["readutf8"].apply(null, arguments)
};
...
if (typeof exports === 'object' && typeof module === 'object')
      ...
      define([], function() { return useString; });
